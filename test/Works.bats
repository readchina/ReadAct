...
@test "Works: language in PrimarySource.language" {
  run mlr --csv join -j language -r iso_code --np --ul -f csv/data/PrimarySource.csv then cut -f language then uniq -a -n csv/data/IsoLangCode.csv
  [ "$status" -eq 0 ]
  [ "${lines[1]}" -eq 0 ]
}
...
@test "Works: language in SecondarySource.language" {
  run mlr --csv join -j language -r iso_code --np --ul -f csv/data/SecondarySource.csv then cut -f language then uniq -a -n csv/data/IsoLangCode.csv
  [ "$status" -eq 0 ]
  [ "${lines[1]}" -eq 0 ]
}
...
@test "Works: language in ArtWork.language" {
  run mlr --csv join -j language -r iso_code --np --ul -f csv/data/ArtWork.csv then cut -f language then uniq -a -n csv/data/IsoLangCode.csv
  [ "$status" -eq 0 ]
  [ "${lines[1]}" -eq 0 ]
}
...
# Genre
@test "Works: language in Genre.language" {
  run mlr --csv join -j language -r iso_code --np --ul -f csv/data/Genre.csv then cut -f language then uniq -a -n csv/data/IsoLangCode.csv
  [ "$status" -eq 0 ]
  [ "${lines[1]}" -eq 0 ]
}

# ArtForm
@test "Works: language in ArtForm.language" {
  run mlr --csv join -j language -r iso_code --np --ul -f csv/data/ArtForm.csv then cut -f language then uniq -a -n csv/data/IsoLangCode.csv
  [ "$status" -eq 0 ]
  [ "${lines[1]}" -eq 0 ]
}
